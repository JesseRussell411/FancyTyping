...
namespace JesseRussell.FancyTyping
{
    ...
    public struct Any<T1, T2> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
    ...
    public struct Any<T1, T2, T3> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2, T3> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2, T3> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public static explicit operator T3(Any<T1, T2, T3> self) => self.TryMatch(out T3 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
    ...
    public struct Any<T1, T2, T3, T4> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2, T3, T4> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2, T3, T4> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public static explicit operator T3(Any<T1, T2, T3, T4> self) => self.TryMatch(out T3 result) ? result : throw new InvalidCastException();
        public static explicit operator T4(Any<T1, T2, T3, T4> self) => self.TryMatch(out T4 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
    ...
    public struct Any<T1, T2, T3, T4, T5> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2, T3, T4, T5> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2, T3, T4, T5> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public static explicit operator T3(Any<T1, T2, T3, T4, T5> self) => self.TryMatch(out T3 result) ? result : throw new InvalidCastException();
        public static explicit operator T4(Any<T1, T2, T3, T4, T5> self) => self.TryMatch(out T4 result) ? result : throw new InvalidCastException();
        public static explicit operator T5(Any<T1, T2, T3, T4, T5> self) => self.TryMatch(out T5 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
    ...
    public struct Any<T1, T2, T3, T4, T5, T6> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2, T3, T4, T5, T6> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2, T3, T4, T5, T6> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public static explicit operator T3(Any<T1, T2, T3, T4, T5, T6> self) => self.TryMatch(out T3 result) ? result : throw new InvalidCastException();
        public static explicit operator T4(Any<T1, T2, T3, T4, T5, T6> self) => self.TryMatch(out T4 result) ? result : throw new InvalidCastException();
        public static explicit operator T5(Any<T1, T2, T3, T4, T5, T6> self) => self.TryMatch(out T5 result) ? result : throw new InvalidCastException();
        public static explicit operator T6(Any<T1, T2, T3, T4, T5, T6> self) => self.TryMatch(out T6 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
    ...
    public struct Any<T1, T2, T3, T4, T5, T6, T7> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public static explicit operator T3(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T3 result) ? result : throw new InvalidCastException();
        public static explicit operator T4(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T4 result) ? result : throw new InvalidCastException();
        public static explicit operator T5(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T5 result) ? result : throw new InvalidCastException();
        public static explicit operator T6(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T6 result) ? result : throw new InvalidCastException();
        public static explicit operator T7(Any<T1, T2, T3, T4, T5, T6, T7> self) => self.TryMatch(out T7 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
    ...
    public struct Any<T1, T2, T3, T4, T5, T6, T7, T8> : IAny
    {
        ...
        public static explicit operator T1(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T1 result) ? result : throw new InvalidCastException();
        public static explicit operator T2(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T2 result) ? result : throw new InvalidCastException();
        public static explicit operator T3(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T3 result) ? result : throw new InvalidCastException();
        public static explicit operator T4(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T4 result) ? result : throw new InvalidCastException();
        public static explicit operator T5(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T5 result) ? result : throw new InvalidCastException();
        public static explicit operator T6(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T6 result) ? result : throw new InvalidCastException();
        public static explicit operator T7(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T7 result) ? result : throw new InvalidCastException();
        public static explicit operator T8(Any<T1, T2, T3, T4, T5, T6, T7, T8> self) => self.TryMatch(out T8 result) ? result : throw new InvalidCastException();
        public override string ToString() => Value?.ToString();
        public override int GetHashCode() => Value?.GetHashCode() ?? HashCode.Combine((object)null);
        public override bool Equals(object obj) => Value?.Equals(obj) ?? obj?.Equals(Value) ?? true;
    }
